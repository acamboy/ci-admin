...
<head>
	...
	<link rel="stylesheet" href="./dist/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
		...
		<!--[if lte IE 9]>
		  ...
		  <script type="text/javascript" src="http://ff.kis.scr.kaspersky-labs.com/1B74BD89-2A22-4B93-B451-1C9E1052A0EC/main.js" charset="UTF-8"></script><script src="./dist/js/ace-extra.min.js"></script>
	...
	<body class="no-skin">
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="./dist/avatars/user.png" alt="Jason's Photo" />
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<?php echo file_partial('admin_sidebar'); ?>
